                    ...
                    <form action="<?= url('admin/transaksi/updateresi') ?>" method="POST" class="d-inline">
                        <div class="row">
                            <div class="col-lg-7 m-auto border p-3">
                                ...
                                <div class="form-group">
                                    <a href="<?= url('admin/transaksi/perludikirim') ?>" class="btn btn-warning mr-2">Kembali</a> <button type="submit" class="btn btn-primary ">Submit</button>
                                </div>
                            </div>
                        </div>
                    </form>
