                ...
                <div class="invoice-print">
                    ...
                    <div class="row mt-4">
                        <div class="col-md-12">
                            ...
                            <div class="row mt-4">
                                <div class="col-lg-8">
                                    <form action="<?= url('admin/transaksi/updateresi') ?>" method="POST" class="d-inline">
                                        <div class="row">
                                            <div class="col-lg-11 m-auto border p-3">
                                                <input type="hidden" name="invoice" value="<?= $data['order']['o_invoice'] ?>">
                                                <div class="form-group">
                                                    <label for="">Kurir Pengiriman</label>
                                                    <input type="text" name="kurir" id="" class="form-control" required>
                                                </div>

                                                <div class="form-group">
                                                    <label for="">Nomor Resi</label>
                                                    <input type="text" name="resi" id="" class="form-control" required>
                                                </div>

                                                <div class="form-group text-right">
                                                    <a href="<?= url('admin/transaksi/perludikirim') ?>" class="btn btn-warning mr-2">Kembali</a>
