                            ...
                            <div class="card-body">
                                <div class="form-row">
                                    <div class="form-group col-md-12">
                                        ...
                                        <input type="text" class="form-control" name="p_nama" value="<?= $data['produk']['p_nama'] ?>">
                                    </div>
                                </div>
                                ...
                                <div class="form-row">
                                    <div class="form-group col-md-6">
                                        <label>Stok</label>
                                        <input type="number" class="form-control" name="p_stok" value="<?= $data['produk']['p_stok'] ?>">
                                    </div>
                                    <div class="form-group col-md-6">
                                        <label>Harga</label>
                                        <input type="number" class="form-control" name="p_harga" value="<?= $data['produk']['p_harga'] ?>">
                                    </div>
                                </div>
